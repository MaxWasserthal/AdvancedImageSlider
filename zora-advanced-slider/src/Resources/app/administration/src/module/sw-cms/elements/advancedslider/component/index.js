import template from './sw-cms-el-advancedslider.html.twig';
import './sw-cms-el-advancedslider.scss';

const { Component, Mixin, Filter } = Shopware;

Component.register('sw-cms-el-advancedslider', {
    template,
    ...
    methods: {
        createdComponent() {
            ...
            this.initElementData('advancedslider');
